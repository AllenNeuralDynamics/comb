...
Changes from AllenSDK:
+ add function to change image_dictionaries file path

TODO:
+ make sure Trials is included
+ add back is_images_novel
+ add back project_code
...
class Presentations(DataObject):
